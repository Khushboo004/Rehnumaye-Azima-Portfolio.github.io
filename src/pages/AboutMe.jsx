...
const AboutMe = () => {
  ...
  return (
    <div
      className="about text-white border shadow-2xl "
      id="about"
      style={{ paddingTop: "20px", width:"100%", paddingBottom: "20px" }}
    >
      <h1 className="text-center text-4xl font-bold text-yellow-500 underline underline-offset-8 py-12">
        About Me
      </h1>
      <Grid container spacing={2} className="text-center ">
        ...
        <Grid item xs={8} className="md:text-2xl text-1xl -mono">
          ...
          <div className="text-gray-400 py-4 font">
            I have a deep passion for coding. I spend my time coding and
            technology. I am dedicated to staying current with the latest
            developments in technology and am always looking for new ways to
            apply it. My passion drives me to create innovative solutions and
            applications. I am always looking for new challenges and
            opportunities to apply my knowledge and skills using technology.
          </div>
        </Grid>
        <Grid item xs={2}></Grid>
      </Grid>
