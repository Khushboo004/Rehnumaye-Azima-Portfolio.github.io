...
<Grid item md ={4} xs={12}>
  <Box p={4} bgcolor="lightgray" borderRadius={4} textAlign="center">
    ...
    <p>I can read, write, speak English.</p> {/* Added paragraph text */}
  </Box>
</Grid>
<Grid item md ={4} xs={12}>
  <Box p={4} bgcolor="lightgray" borderRadius={4} textAlign="center">
    <h1 className="text-3xl font-bold">Bangla</h1>
    <p>I can read, write, speak  Bangla.</p> {/* Added paragraph text */}
  </Box>
</Grid>
<Grid item md ={4} xs={12}>
  <Box p={4} bgcolor="lightgray" borderRadius={4} textAlign="center">
    <h1 className="text-3xl font-bold">Hindi</h1>
    <p>I can understand & speak Hindi</p> {/* Added paragraph text */}
  </Box>
</Grid>
</Grid>
